...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css2/reset.css" type="text/css" media="all">
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css2/style.css" type="text/css" media="all">
